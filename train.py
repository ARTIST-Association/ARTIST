...
# ##Aimpoints
# # Receiver
# aimpoint = th.tensor([-25,0,5], dtype=th.float32, device=device)
...
# #sunposition
# sun_orig = th.tensor([0,0,1], dtype=th.float32, device=device)
# mean = th.tensor([0, 0], dtype=th.float32, device=device)
# cov = th.tensor([[0.002090**2, 0], [0, 0.002090**2]], dtype=th.float32, device=device)  # diagonal covariance, used for ray scattering
