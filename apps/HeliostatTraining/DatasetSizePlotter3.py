...
def addDataToPlot(data_dir : str, size_plot, label: str, color : str, dashes : str, marker : str):
    results = {}
    ...
    index = 2
    size_plot.plot([k for k in results.keys()], [v[1][index] for v in results.values()], c=color, linestyle=dashes, linewidth=3, label=label, marker=marker, markersize=10)
    # size_plot.scatter([k for k in results.keys()], [v[1][index] for v in results.values()], c=color, marker=marker, label=label)
...
def main(data_dirs : typing.List[str], labels : typing.List[str], colors : typing.List[str], dash_list : typing.List[str], marker_list : typing.List[str]):
    ...
    for i, (data_dir, label, color, dashes, marker) in enumerate(zip(data_dirs, labels, colors, dash_list, marker_list)):
        size_array, dist_array, nt_array = addDataToPlot(data_dir=data_dir, size_plot=plt_ax1, label=label, color=color, dashes=dashes, marker=marker)
        # plt_ax2_2.plot(size_array, nt_array, color=color)
        if (i%2 == 1):
            plt_ax2.plot(size_array, dist_array, c='grey', linewidth=3, marker=marker, markersize=10)
            # plt_ax2.scatter(size_array, dist_array, c='grey', marker=marker)
...
if __name__ == '__main__':
    data_dirs = [
        ...
        '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AJ23 GM',
        # '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM43 NN',
        '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AJ23 PA',
        '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM35 GM',
        # '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM43 NN',
        '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM35 PA',
        '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM42 GM',
        # '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM43 NN',
        '/Users/moritz/Projekte/Alignment Optimizer/data/Training Results/Size Sweep AM42 PA',
    ...
    main(data_dirs=data_dirs, labels=labels, colors=colors, dash_list=dash_list, marker_list=marker_list)