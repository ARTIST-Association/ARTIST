...
from HeliostatTrainingLib.TrainingManagement import TrainingSchedulerClient
...
def main(training_dir: typing.Optional[str] = None):
    ...
    # dataset = builder.buildDistanceThreshold(
    #                                         data_points=file_path,
    #                                         csv_input_reader_type = HeliOSDatasetCSV,
    #                                         heliostats_list = heliostat_list,
    #                                         # created_at_range = [start_date,None],
    #                                         created_at_range = [datetime.datetime(year=2022, month=1, day=1),None],
    #                                         threshold = 0.25,
    #                                         )
    ...
    for i in range(1):
        ...
        # dataset = builder.buildRandomlyFromNumbers(data_points= file_path,
        #                                             num_train_data = 300,
        #                                             num_test_data = 20,
        #                                             num_eval_data = 30,
        #                                             csv_input_reader_type = HeliOSDatasetCSV,
        ...
        training = HT.HeliostatTraining(dataset=dataset, alignment_model=alignment, name='Test', dtype=torch.float64)
        training_manager.addTraining(training)

if __name__ == '__main__':
    main()
    # tsc = TrainingSchedulerClient()
    # tsc.scheduleTraining(training_dir = 'xxx')
