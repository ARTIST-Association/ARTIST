...
#     [0.6424999833106995, 0.8075000047683716, 0.040198374539613724],
# ]
# _C.H.FUNCTION.FACETS.SPANS_N = [
#     [0.0, 0.8024845123291016, -0.004984567407518625],
#     [0.0, 0.8024845123291016, 0.004984567407518625],
#     [0.0, 0.8024845123291016, -0.004984567407518625],
#     [0.0, 0.8024845123291016, 0.004984567407518625],
# ]
# _C.H.FUNCTION.FACETS.SPANS_E = [
...
_C.TRAIN.LOSS.PIXEL_CLOSENESS           = CN()
_C.TRAIN.LOSS.PIXEL_CLOSENESS.FACTOR    = 50.0
_C.TRAIN.LOSS.PIXEL_CLOSENESS.NORM_P    = 1.0
