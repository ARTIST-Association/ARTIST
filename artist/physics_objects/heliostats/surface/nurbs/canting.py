...
if TYPE_CHECKING:
    from artist.physics_objects.heliostats.surface.nurbs.multi_nurbs_surface import ASurface
...
def decant_facet(
    ...
    if canting_params is None:
        ...
        from artist.physics_objects.heliostats.surface.nurbs.multi_nurbs_surface import heliostat_coord_system
