...
_C.IDEAL.FACETS.CANTING = CfgNode()
...
_C.DEFLECT_DATA.FACETS = CfgNode()
# Positions and spans are read from the data.
_C.DEFLECT_DATA.FACETS.CANTING = CfgNode()
...
_C.OTHER.FACETS.CANTING = CfgNode()
...
def load_config_file(cfg: CfgNode) -> CfgNode:
    """
    [INSERT DESCRIPTION HERE!].
