...
import artist.physics_objects.heliostats.surface.nurbs as nurbs
if TYPE_CHECKING:
    from artist.physics_objects.heliostats.surface.facets.nurbs_heliostat import NURBSHeliostat
