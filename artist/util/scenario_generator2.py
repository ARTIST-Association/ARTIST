...
class ScenarioGenerator:
    ...
    tower_area_list_config : TowerAreaListConfig
        The tower area list configuration object.
    ...
    def __init__(
        ...
        plant. The scenario generator creates the scenarios. A scenario encompasses the tower(s), the
        ...
        self.tower_area_list_config = tower_area_list_config
        ...
        self.log = utils.setup_logging("scenario-generator")
    ...
    def generate_scenario(self) -> None:
        ...
        with h5py.File(save_name, "w") as f:
            ...
            # Include parameters for the tower areas.
            self.log.info("Including parameters for the towers")
            self.include_parameters(
                file=f,
                prefix=config_dictionary.tower_areas_key,
                parameters=self.flatten_dict(
                    self.tower_area_list_config.create_tower_area_list_dict()
                ),
            )
