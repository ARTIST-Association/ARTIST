...
scenario_paths =[
    ...
    # ),
    # pathlib.Path(
    #     "/workVERLEIHNIX/mb/ARTIST/tutorials/data/scenarios/test_scenario_paint_multiple_heliostat_groups_ideal_10_cp.h5"
    # ),
    # pathlib.Path(
    #     "/workVERLEIHNIX/mb/ARTIST/tutorials/data/scenarios/test_scenario_paint_multiple_heliostat_groups_ideal_25_cp.h5"
    # ),
    # pathlib.Path(
    #     "/workVERLEIHNIX/mb/ARTIST/tutorials/data/scenarios/test_scenario_paint_multiple_heliostat_groups_ideal_50_cp.h5"
    # ),
    pathlib.Path(
        "/workVERLEIHNIX/mb/ARTIST/tutorials/data/scenarios/test_scenario_paint_multiple_heliostat_groups_ideal_8_cp.h5"
    ),
]
...
with setup_distributed_environment(
    ...
    # - number of rays [1, 3, 9, 27]
    # - evaluation points [50, 100]
    # - (resolution) [64, 128, 256]
    # - number of control points [5, 10, 25, 50]
    # - regularisation [none, xyz, xy]
    # - 288 combinations
